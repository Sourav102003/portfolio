        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
        I am a motivated MERN Stack Develper and aspiring web developer with a strong passion for
modern web technologies. I enjoy solving real-world problems through creative design and clean,
optimized code. With a continuous learning mindset, I strive to improve my technical skills and stay
