...
const WORDS = ["B.Tech CSE Student", "Tech Enthusiast"];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sourav — MERN Stack Develper</title>
        <meta name="description" content="Website Sourav, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                   Creating websites that are creative, useful, and easy for people to use, to provide digital solutions.
                  </p>
